...
//----------------METODO PARA CAMBIAR COLOR DE LA MESA-----------
    ...
    public void aplicarColoresActivarColor(String color, ArrayList<String> colores) {


        if (color.equalsIgnoreCase("ROJO")) {

            System.out.println("HAZ CAMBIADO EL COLOR DE LA MESA A " + (colores.get(0) + color.toUpperCase() + colores.get(1)));

        } else if (color.equalsIgnoreCase("VERDE")) {

            System.out.println("HAZ CAMBIADO EL COLOR DE LA MESA A " + (colores.get(2) + color.toUpperCase() + colores.get(3)));
